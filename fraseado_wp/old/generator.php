		...
		<div class="post-article">
			<div>
				...
				<div class="button download">
					<a href="#" data-event-category="site-generator-download" data-event-action="minha-imagem"><span>Clique aqui</span> para salvar a imagem!</a>
				</div>
			</div>
...
<?php } ?>
<link href="<?php echo get_template_directory_uri(); ?>/css/generator.css?v2" rel="stylesheet">
<script src="<?php echo get_template_directory_uri(); ?>/js/generator.js"></script>
<?php get_footer(); ?>